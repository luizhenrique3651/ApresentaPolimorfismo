 ...
 * @author luiz
 */
public class ControleTv2 extends javax.swing.JFrame  {
    ModeloTV002 tv2 = new ModeloTV002(41);
    int contador;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ControleTv2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ControleTv2().setVisible(true);
            }
        });
    }
